...
@section('cnt')
    ...
    <article class="page-container">
        ...
        <form action="{{ route('admin.user.edit',$info) }}" method="post" class="form form-horizontal" id="form-member-add">
            {{--{{ method_field('PUT') }}--}}
            {{-- 让表单模拟put提交 --}}
            @method('PUT')
            @csrf
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="email" class="input-text" name="email" value="{{ $info->email }}">
                </div>
            </div>
            <div class="row cl">
