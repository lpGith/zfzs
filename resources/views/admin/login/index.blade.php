        ...
        <form class="form form-horizontal" action="{{ route('admin.login') }}" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    <input name="username" type="text" {{old('username')}} class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-xs-8">
                    <input name="password" {{old('password')}} type="password" class="input-text size-L">
                </div>
            </div>
            {{--<div class="row cl">
...
<div class="footer">Copyright zfz</div>
